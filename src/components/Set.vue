      ...
      <el-collapse-item title="个性壁纸" name="1">
        <div class="bg-set">
          <el-radio-group v-model="coverType" text-color="#ffffff" @change="radioChange">
            ...
            <el-radio label="1" size="large" border>必应壁纸</el-radio>
...
const { coverType, siteStartShow, musicClick, playerLrcShow, footerBlur, dark } = storeToRefs(store);
